...
export default function Component() {
  return (
    <div className="relative w-full h-[56.25vw] max-h-[80vh] min-h-[400px] overflow-hidden z-0">
      {/* Background Image */}
      <Image
        src="https://imgsrv.crunchyroll.com/cdn-cgi/image/fit=contain,format=auto,quality=94,width=3840/CurationAssets/As%20a%20Reincarnated%20Aristocrat,%20I'll%20Use%20My%20Appraisal%20Skill%20to%20Rise%20in%20the%20World/SEASON%202/ULTRA-WIDE/AsAReincarnatedAristocrat_S2_UltraWide_LTR.png"
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-xl sm:ml-24">
          ...
          <p className="text-lg sm:text-xl text-gray-200 mb-6">
            A brief description of the anime or manga series. Exciting
            adventures await!
          </p>
